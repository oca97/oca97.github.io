...
map.getView().fit([-8085501.973828, -391241.883698, -3306891.553106, 2206620.083736], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Eligibilité xGFixe (4G et 5G Fixe)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (355 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Pour vérifier si l\'adresse du client permet d\'avoir les meilleurs débits pour les offres 4GHome et 4GWork ou connaitre son éligibilité aux offres 5G Fixe :<br />- Cliquer sur la loupe ci-dessous<br />- Inscrire l\'adresse<br />- Vérifier si l\'adresse est dans une zone de couverture de couleur violette (éligible au 5G Fixe) ou orange (éligible au meilleur débit 4G Fixe)';
            }
